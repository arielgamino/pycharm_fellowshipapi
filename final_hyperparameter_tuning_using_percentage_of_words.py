"""
This is the final code use to build the models. It tries multiple models
by tweaking three hyperparameters:
...
Step 2 - Extract most_common words up to the percentage (upto_percentage) indicated
Step 3 - Divide data set into training and test sets
Step 4 - Build model
Step 5 - Test a sample of europarl.test against the model
...
for number_of_documents in [1000,5000, 10000]:
    # -------------Step 1-------------
